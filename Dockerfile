...
COPY Twitter/config /Twitter/Twitter/config
...
RUN apt-get update \
    ...
    && ln -s /opt/venv/bin/Twitter Twitter # Make sure we use the virtualenv \
    && chmod +x docker-entrypoint.sh

VOLUME /Twitter/backtesting
VOLUME /Twitter/logs
VOLUME /Twitter/tentacles
VOLUME /Twitter/user
